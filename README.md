...
> A C# console application developed for the South African Department of Cybersecurity's public education campaign. CyberShield SA educates citizens on **phishing**, **password safety**, and **suspicious links** through an engaging, interactive conversational interface.
...
| Feature | Description |
|---|---|
| 🎨 ASCII Art Logo | CyberShield SA banner rendered in colour on launch |
...
| `purpose` | What CyberShield SA is and how it protects your privacy |
...
- `DisplayLogo()` — multi-colour ASCII art
...
CyberShield SA does **not** collect, store, or transmit any personal information. All data (your name and session details) exists only in memory for the duration of the session and is discarded on exit.
...
*Built with ❤️ for South Africa — CyberShield SA, PROG6211, 2024*
